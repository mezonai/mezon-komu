...
@Command('dailypm')
export class DailyPmCommand extends CommandMessage {
  constructor(
    ...
    const components = [
      {
        components: [
          {
            id: `dailyPm_${messageid}_${clanId}_${modeMess}_${codeMess}_${isPublic}_${ownerSenderDaily}_${formattedDate}_cancel`,
          ...
          {
            id: `dailyPm_${messageid}_${clanId}_${modeMess}_${codeMess}_${isPublic}_${ownerSenderDaily}_${formattedDate}_submit`,
            type: EMessageComponentType.BUTTON,
            component: {
              label: `Submit`,
