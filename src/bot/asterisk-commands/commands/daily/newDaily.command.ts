...
@Command('newdaily')
export class NewDailyCommand extends CommandMessage {
  constructor(
  ...
  async execute(args: string[], message: ChannelMessage) {
    ...
    const onlyDailySyntax =
      message?.content?.t && typeof message.content.t === 'string'
        ? message.content.t.trim() === '*newdaily'
        : false;
    ...
    const components = [
      {
        components: [
          ...
          {
            id: `newdaily_${messageid}_${clanId}_${modeMess}_${codeMess}_${isPublic}_${ownerSenderDaily}_${formattedDate}_submit`,
            type: EMessageComponentType.BUTTON,
            component: {
              label: `Submit`,
